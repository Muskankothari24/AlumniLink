  ...
  return (
    <div>
      <div style={{backgroundColor:"white",padding:"15px",borderRadius:"10px"}}>
         ...
         <img  onClick={()=>  filePostRef.current?.click()}  style={{width:"30px",marginLeft:"140px"}} src={calendar}/> Event
         <img  onClick={()=>  filePostRef.current?.click()}  style={{width:"30px",marginLeft:"90px"}} src={article}/> Write Article
         </div>
   ...
   return<Card>
    ...
    {post.filePost && <CardMedia component="img"
            height={250}
