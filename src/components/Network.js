                 ...
                 <List>
                     <ListItem>
                         ...
                         {/* <Link to="/message" state={{currentUserName:location.state.currentUserName,
                            ...
                            id:eachUser.id,
                            profile_image:eachUser.profile_image}}> </Link> */ 
                           }
                         <Link to="/message" state={{currentUserName:location.state.currentUserName, currentProImg:location.state.currentUserProImg,username:eachUser.username,
                         id:eachUser.id,
